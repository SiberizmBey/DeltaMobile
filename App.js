        ...
        <View style={[styles.flex1, { backgroundColor: theme.background }]}>
            ...
            <View style={styles.header}>
                ...
                <TouchableOpacity onPress={handleLogout}>
                    <LogOut color={theme.primary} size={24} />
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.footer}>
                <Text style={[styles.footerText, { color: theme.subText }]}>
                    Sitedeki QR kodu kutucuğun içine odaklayın
                </Text>
            </View>
        </View>
    );
...
function HomeScreen() {
    ...
    useEffect(() => {
        fetch("https://labs.anticvalley.com.tr/labs.data.json")
            .then((res) => res.json())
        ...
        >
            <View style={styles.cardHeader}>
                <Text style={styles.cardBadge}>
                    {isProject ? "PROJE" : "DENEY"}
                </Text>
                <Text style={[styles.cardStage, { color: theme.subText }]}>
        ...
        >
            ...
            >
                <View style={styles.labsHero}>
                    <Text style={[styles.labsHeroTitle, { color: theme.text }]}>
                        Nexa Labs
                    </Text>
                    <Text
                        style={[styles.labsHeroSub, { color: theme.subText }]}
                    >
                        Ar-Ge ve Prototip Merkezi
                    </Text>
                </View>
                    ...
                    >
                        ...
                        <ScrollView>
                            <Text style={styles.detailHeroText}>
                                {selectedItem?.detail?.hero}
                            </Text>
                            <Text
                                style={[
                                    styles.detailLongDesc,
                                    { color: theme.text },
                                ]}
                            >
                                {selectedItem?.detail?.longDescription}
                            </Text>
                            <View style={styles.tagRow}>
                                {selectedItem?.detail?.stack?.map((s, i) => (
                                    ...
                                    >
                                        <Text style={styles.stackTagText}>
                                            {s}
                                        </Text>
                                    </View>
                                ))}
...
function SocialScreen() {
    ...
    useEffect(() => {
        AsyncStorage.getItem("user_id").then((id) => {
            setMyId(id);
            fetch(
                `https://nexaverse.anticvalley.com.tr/api/v2/messages.php?action=list_all&user_id=${id}`,
            )
                .then((res) => res.json())
    ...
    const openChat = async (conv) => {
        ...
        const res = await fetch(
            `https://nexaverse.anticvalley.com.tr/api/v2/messages.php?action=fetch_messages&conversation_id=${conv.id}`,
        );
    ...
    if (view === "chat") {
        return (
            ...
            >
                ...
                >
                    <View
                        style={[styles.chatInputRow, { paddingHorizontal: 20 }]}
                    >
                        <TextInput
                            style={[
                                styles.chatInput,
    ...
    return (
        ...
        >
            <Text
                style={[styles.sectionTitle, { marginLeft: 20, marginTop: 20 }]}
            >
                Sosyal
            </Text>
            <FlatList
                ...
                renderItem={({ item }) => {
                    const otherName =
                        item.user1_id == myId ? item.user2_dn : item.user1_dn;
                    return (
                        <TouchableOpacity
                            style={[
                                styles.menuItem,
                        ...
                        >
                            <Image
                                source={{
                                    uri: `https://nexaverse.anticvalley.com.tr/${item.user2_pic || "default.png"}`,
                                }}
...
function ProfileScreen({ handleLogout }) {
    ...
    useEffect(() => {
        const loadUser = async () => {
            ...
            const fullPicUrl = pic
                ? pic.startsWith("http")
                    ? pic
                    : `https://nexaverse.anticvalley.com.tr/${pic}`
                : null;
        ...
        useCallback(() => {
            ...
            const checkUpdates = async () => {
                ...
                try {
                    ...
                    const GITHUB_APP_JSON_URL =
                        "https://raw.githubusercontent.com/SiberizmBey/DeltaMobile/main/app.json";
        ...
        >
            <ScrollView contentContainerStyle={{ paddingBottom: 120 }}>
                <View style={styles.newProfileHeader}>
                    ...
                    <Text style={[styles.profileId, { color: theme.subText }]}>
                        Üye ID: {userData.id || "---"}
                    </Text>
                </View>
                ...
                <View style={{ paddingHorizontal: 20, marginTop: 30 }}>
                    ...
                    >
                        ...
                        {updateStatus.loading ? (
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() =>
                                    Linking.openURL(
                                        "https://github.com/SiberizmBey/DeltaMobile",
                                    )
                                }
                            >
                                <Text style={styles.updateTitle}>
                                    YENİ SÜRÜM MEVCUT (v{updateStatus.latest})
                                </Text>
                                <Text style={styles.updateSub}>
                                    Güncellemek için GitHub'a git.
                                </Text>
                            </TouchableOpacity>
                        ) : (
                    ...
                    >
                        ...
                        <Text
                            style={[styles.menuText, { color: theme.primary }]}
                        >
                            Oturumu Kapat
                        </Text>
                    </TouchableOpacity>
    ...
    const options = [
        {
            id: "system",
            label: "Sistem Teması",
            icon: <Monitor size={20} color={theme.text} />,
        },
        {
            id: "light",
            label: "Aydınlık Mod",
        ...
        },
        {
            id: "amoled",
            label: "AMOLED",
            icon: <ShieldCheck size={20} color={theme.text} />,
        },
    ];
                ...
                <View style={{ paddingHorizontal: 20 }}>
                    ...
                    >
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                Linking.openURL(
                                    "https://github.com/SiberizmBey/NexaVerse-Mobile",
                                )
                            }
                        >
                            <Image
                                source={{
                                    uri: "https://nexaverse.anticvalley.com.tr/assets/img/nforum.png",
                                }}
                                style={{
                                    width: 30,
                                    height: 30,
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                Linking.openURL(
                                    "https://github.com/SiberizmBey/Asedia",
                                )
                            }
                        >
                            <Image
                                source={{
                                    uri: "https://raw.githubusercontent.com/SiberizmBey/Asedia/main/assets/images/icon.png",
                                }}
                                style={{
                                    width: 30,
                                    height: 30,
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                Linking.openURL(
                                    "https://github.com/SiberizmBey/SIsKip",
                                )
                            }
                        >
                            <Image
                                source={{
                                    uri: "https://raw.githubusercontent.com/SiberizmBey/SisKip/main/assets/images/icon.png",
                                }}
                                style={{
                                    width: 30,
                                    height: 30,
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                Linking.openURL(
                                    "https://github.com/SiberizmBey/Mira",
                                )
                            }
                        >
                            <Image
                                source={{
                                    uri: "https://raw.githubusercontent.com/SiberizmBey/Mira/main/assets/images/icon.png",
                                }}
                                style={{
                                    width: 30,
                                    height: 30,
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                Linking.openURL(
                                    "https://github.com/SiberizmBey/SeMira",
                                )
                            }
                        >
                            <Image
                                source={{
                                    uri: "https://raw.githubusercontent.com/SiberizmBey/SeMira/main/assets/images/icon.png",
                                }}
                                style={{
                                    width: 30,
                                    height: 30,
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                Linking.openURL(
                                    "https://github.com/SiberizmBey/PyMira",
                                )
                            }
                        >
                            <Image
                                source={{
                                    uri: "https://raw.githubusercontent.com/SiberizmBey/PyMira/main/assets/images/icon.png",
                                }}
                                style={{
                                    width: 30,
                                    height: 30,
                    ...
                    >
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                Linking.openURL(
                                    "https://instagram.com/nexabag.media",
                                )
                            }
                        >
                            <View
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                Linking.openURL("https://x.com/SiberizmBey")
                            }
                        >
                            <View
                                style={{
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                Linking.openURL(
                                    "https://nexaverse.anticvalley.com.tr/profile.php?id=NexaBAGStudi",
                                )
                            }
                        >
                            <View
                            ...
                            >
                                <Image
                                    source={{
                                        uri: "https://nexaverse.anticvalley.com.tr/assets/img/nforum.png",
                                    }} // Buraya kendi ikon URL'ni yapıştır
                                    style={{
                                        width: 30,
                                        height: 30,
                                        resizeMode: "contain",
...
export default function App() {
    ...
    const handleLogin = async () => {
        ...
        try {
            const res = await fetch(
                "https://nexaverse.anticvalley.com.tr/api/v2/auth.php",
                {
                    method: "POST",
    ...
    const handleBarCodeScanned = async ({ data }) => {
        ...
        const response = await fetch(
            "https://nexaverse.anticvalley.com.tr/qr_verify.php",
            {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    if (checkingAuth)
        return (
            <View style={styles.darkBg}>
                <ActivityIndicator color="#901d35" />
            </View>
        );
        ...
        return (
            <KeyboardAvoidingView style={styles.darkBg}>
                <View style={styles.loginCard}>
                    ...
                    <Text style={styles.deltaMiniTitle}>
                        Bir NexaBAG Studios uygulamasıdır
                    </Text>
                    ...
                    >
                        {loading ? (
                            ...
                            <Text style={styles.deltaButtonText}>
                                GİRİŞ YAP
                            </Text>
                        )}
                    </TouchableOpacity>
            ...
            <NavigationContainer>
                ...
                >
                    <Tab.Screen
                        ...
                        options={{
                            tabBarIcon: ({ color }) => (
                                <FlaskConical color={color} size={24} />
                            ),
                        }}
                    />
                    <Tab.Screen
